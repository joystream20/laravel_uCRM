                          ...
                          <div class="container px-4 py-4 mx-auto">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  <div style="display: inline-block; background:#abc;"><button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">顧客編集</button></div>
                                </div>
