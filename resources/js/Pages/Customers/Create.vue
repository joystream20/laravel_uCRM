                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2  w-full">
                                  <div class="relative">
                                    ...
                                    <div>
                                      <input type="radio" id="gender0" name="gender" value="0" v-model="form.gender" class="">
                                      <label for="gender0" class="leading-7 text-sm text-gray-600 mr-2">男</label>

                                      <input type="radio" id="gender1" name="gender" value="1" v-model="form.gender" class="">
                                      <label for="gender1" class="leading-7 text-sm text-gray-600 mr-2">女</label>

                                      <input type="radio" id="gender2" name="gender" value="2" v-model="form.gender" class="">
                                ...
                                <div class="p-2 w-full">
                                  <div style="display: inline-block; background:#abc;"><button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">顧客登録</button></div>
                                </div>
