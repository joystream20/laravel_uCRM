                    ...
                    <section class="text-gray-600 body-font relative">
                      ...
                      <div class="container px-5 py-8 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          ...
                          <div class="p-2 w-full">
                              <div style="display: inline-block; background:#abc;">
                                <Link as="button" :href="route('items.edit',{
                                  item: item.id
                                })">
                                <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集する</button>
                              </Link>
                              </div>
                            </div>
                            ...
                            <div class="mt-20 p-2 w-full">
                              <div style="display: inline-block; background:#abc;">
                                ...
                                <button @click="deleteItem(item.id)" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded text-lg">削除する</button>
