                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2  w-full">
                                  <div class="relative">
                                    ...
                                    <input type="radio" name="is_selling" id="is_selling" value="1" v-model="form.is_selling">
                                    <label class="ml-2 mr-4">販売中</label>
                                    <input type="radio" name="is_selling" id="is_selling" value="0" v-model="form.is_selling">
                                    <label class="ml-2 mr-4">停止中</label>
                                  </div>
                                </div>

                                <div class="p-2 w-full">
                                  <div style="display: inline-block; background:#abc;"><button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button></div>
                                </div>
